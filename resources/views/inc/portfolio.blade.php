        ...
        <div class="col-sm pad-bot">
            <div class="card boxshadow" style="width: 14rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">A map containing the simulated locations of taxicabs. Built using Mapbox and
                        Leaflet
                    </p>
    ...
    <div class="row">
        ...
        <div class="col-sm pad-bot">
            <div class="card boxshadow" style="width: 14rem;">
                ...
                <div class="card-body">
                    <h4 class="card-title">Todo List</h4>
                    <p class="card-text">Using Ajax via Axios and a simple API
                    </p>
